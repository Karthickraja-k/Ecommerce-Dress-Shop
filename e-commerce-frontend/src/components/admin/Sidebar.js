    ...
    return (
        <div className="sidebar-wrapper">
            <nav id="sidebar">
                ...
                <li>
                    <Link to="/admin/newsletter"><i className="fa fa-regular fa-envelope"></i>Newsletter</Link>
                </li>

                <li>
                    <Link to="/admin/sales"><i className="fa fa-shopping-basket"></i> Sale Report</Link>                    
                </li>
