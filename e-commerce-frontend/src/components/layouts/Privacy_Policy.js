...
const PrivacyPolicy = () => {
    return (
        <div className="container-fluid privacy-policy-container">
            ...
            <section className="privacy-content">
                <h2>Introduction</h2>
                <p>
                    At Oom Shri Traders, we are committed to protecting your privacy. This Privacy Policy explains how we collect,
                ...
                <p style={{color:'red', fontSize:'25px'}}>
                  *** NCNR - Non Cancelable - Non Refundable.
                </p>
                ...
                <p>
                    ...
                    <br />
                    <strong>Email:</strong> support@osttraders.com
                </p>
            </section>
        </div>
    );
